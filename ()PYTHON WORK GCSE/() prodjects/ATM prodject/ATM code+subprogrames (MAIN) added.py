...
def deposit():   #fix diposit into savings
   global CA,SA
   ...
   if deposit_account==2:
       deposit_savings=int(input("how much would you like to deposit into savings account? £"))
   if deposit_savings>0:
       SA=(SA+deposit_savings)
       return SA
       print("your new balance is,\n"
             "£",SA)
